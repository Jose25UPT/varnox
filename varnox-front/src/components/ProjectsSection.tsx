      ...
      {selectedProject && (
        <div className="fixed inset-0 z-50 bg-black/95 backdrop-blur-sm">
          <div className="w-full h-full bg-gray-100 flex flex-col">
            ...
            <div className="bg-gray-200 px-4 py-3 flex items-center justify-between border-b border-gray-300 flex-shrink-0">
              {/* Browser Controls */}
            ...
            {/* Address Bar */}
            <div className="bg-white px-4 py-3 border-b border-gray-200 flex items-center space-x-3 flex-shrink-0">
              <div className="flex items-center space-x-2">
            ...
            {/* Browser Content - Iframe (AHORA OCUPA TODO EL ESPACIO RESTANTE) */}
            ...
            <div className="bg-gray-100 px-4 py-2 border-t border-gray-300 flex items-center justify-end flex-shrink-0">
              <a
